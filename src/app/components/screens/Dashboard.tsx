      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="p-4 space-y-3">
            ...
            <div className="text-2xl font-mono font-bold text-[#10B981] flex items-center gap-1">
          ...
          <Card className="p-4 space-y-2">
            ...
            <div className="text-2xl font-mono font-bold text-[#EF4444] flex items-center gap-1">
        ...
        {/* Active Copy Traders */}
        <Card className="p-6">
          <h3 className="text-lg font-semibold mb-4">Active Copy Traders</h3>
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between p-3 bg-secondary/30 rounded border border-border">
                <div className="flex items-center gap-4">
                  <div className="size-10 rounded bg-muted flex items-center justify-center text-sm font-semibold">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <Badge variant={trader.status === "running" ? "default" : "secondary"} className="min-w-20 justify-center">
